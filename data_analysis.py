...
def main():
    ...
    print("=" * 70)
    print("📋 Для защиты подготовьте:")
    print("   1. Скриншоты графиков из папки analysis_results/")
    print("   2. Результаты статистических тестов")
    print("   3. Финальный отчет (lab_report.txt)")
    print("=" * 70)
